...
#define RR_QUANTUM 25 /* mudanca feita para quantum do round robin  */
...
int do_noquantum(message *m_ptr)
{
	...
	/* decremento de prioridade removido para rr */
...
{
	return; /* modificado para impedir aging que nao ocorre no 
		round robin */
}
